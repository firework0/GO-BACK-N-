...
PUBLIC	??_C@_0M@CLIIFGL@May?515?52026@			; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0M@CLIIFGL@May?515?52026@
CONST	SEGMENT
??_C@_0M@CLIIFGL@May?515?52026@ DB 'May 15 2026', 00H	; `string'
CONST	ENDS
...
; File C:\Users\34021\Downloads\Lab1(Win+Linux)\Lab1-2024(Win+Linux)\Lab1-Windows-VS2019\protocol.c
;	COMDAT randB
_TEXT	SEGMENT
randB	PROC						; COMDAT
...
; 627  : {
	...
	lea	rcx, OFFSET FLAT:__E0AFA873_protocol@c
...
; 243  : 	lprintf("Protocol.lib, version %s, jiangyanjun0718@bupt.edu.cn\n", VERSION, __DATE__);
	...
	lea	r8, OFFSET FLAT:??_C@_0M@CLIIFGL@May?515?52026@
...
; 551  :         {
	...
	sub	rsp, 232				; 000000e8H
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__1FF36214_time@h
	call	__CheckForDebuggerJustMyCode
	npad	1
